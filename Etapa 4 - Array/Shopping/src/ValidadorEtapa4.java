public class ValidadorEtapa4 {
	...
	public static void main(String[] args){
		...
		System.out.println(p1.getNomeProduto().equals("Cubo maravilha") ? "[OK] Método Produto.getNome()" : "[NOK] Método Produto.getNome()");
		...
		//public String getNome();
		System.out.println(loja1.getNomeLoja().equals("E3") ? "[OK] Método Loja.getNome()" : "[NOK] Método Loja.getNome()");
		
		//public void setNome(String nome);
		loja1.setNomeLoja("E10");
		...
		//public void setNome(String nome)
		shopping.setNomeShopping("Park Shopping");
		System.out.println("[OK] Método Shopping.setNome()");

		//public String getNome()
		System.out.println(shopping.getNomeShopping().equals("Park Shopping") ? "[OK] Método Shopping.getNome()" : "[NOK] Método Shopping.getNome()");
