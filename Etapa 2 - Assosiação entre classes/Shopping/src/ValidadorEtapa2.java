public class ValidadorEtapa2 {
	...
	public static void main(String[] args){
		...
		p1.setDataValidade(new Data(10, 4, 2024));
		...
		System.out.println(p1.estaVencido(new Data(20, 4, 2024)) ? "[OK] Método Produto.estaVencido()" : "[NOK] Método Produto.estaVencido()");
